...
const nunitoSans = Nunito_Sans({ subsets: ["latin"], variable: "--font-sans-var", weight: ["400", "600", "700"], display: "swap" });
const lora = Lora({ subsets: ["latin"], variable: "--font-display-var", weight: ["600", "700"], display: "swap" });
